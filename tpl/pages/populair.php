            ...
            <main>
                ...
                <div class="Aanbevolen">
                        ...
                        echo "<div class='videoThumbBlock'>
                                ...
                                <div class='videoThumb link' data-link='/watch/{$value_1['video_id']}' id='{$videoTools->getVideoName($value_1['videoPath'])}'>
                                <img class='videoThumbImg' src='{uploadsFolder}/{$videoTools->getThumbnail($value_1['videoPath'])}' id='thumb-{$videoTools->getVideoName($value_1['videoPath'])}'>
